...
'			While (UIAWindow("Ejecutivo de interacción").UIAWindow("Autenticación del Cliente").UIAObject("Movistar").UIAButton("Continuar").Exist(5)) = False
'				wait 1
'				If UIAWindow("Ejecutivo de interacción").UIAWindow("Autenticación del Cliente").UIAObject("No se puede acceder a").UIAObject("No se puede acceder a").Exist Then
'					wait 1
'					DataTable("s_Resultado", dtLocalSheet) = "Fallido"
'					DataTable("s_Detalle", dtLocalSheet) = "No hay conexión a la WIC"
'					Reporter.ReportEvent micFail, DataTable("s_Resultado", dtLocalSheet), DataTable("s_Detalle", dtLocalSheet)
'					Wait 5
'					UIAWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() & "WIC_Error.png", True
'					imagenToWord "WIC_Error", RutaEvidencias() &Num_Iter&"_"&"WIC_Error.png"
'					ExitTest
'				End If
'			Wend
'			
'		wait 1
'		UIAWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() &Num_Iter&"_"&""&"Autenticación del Cliente.png" , True
'		imagenToWord "Autenticación del Cliente", RutaEvidencias() &Num_Iter&"_"&"Autenticación del Cliente.png"
'		wait 2
'		UIAWindow("Ejecutivo de interacción").UIAWindow("Autenticación del Cliente").UIAObject("Movistar").UIAButton("Continuar").Click
'		
'			While (UIAWindow("Ejecutivo de interacción").UIAWindow("Autenticación del Cliente").UIAObject("Movistar").UIAButton("Saltar").Exist) = False
'				wait 1	
'			Wend
'		
...
'		else
'			DataTable("s_Resultado", dtLocalSheet) = "Fallido"
'			DataTable("s_Detalle", dtLocalSheet) = "No se habilitó el botón CALCULAR o la página no cargó"
'			Reporter.ReportEvent micFail, DataTable("s_Resultado", dtLocalSheet), DataTable("s_Detalle", dtLocalSheet)
'			UIAWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() & "Wic_Error.png", True
'			imagenToWord "Wic_Error", RutaEvidencias() &Num_Iter&"_"&"Wic_Error.png"
'			UIAWindow("Ejecutivo de interacción").UIAWindow("Autenticación del Cliente").UIAButton("Cerrar").Click
'			wait 3
'			ExitActionIteration	
'		End If
'		
'			While ((UIAWindow("Ejecutivo de interacción").UIAWindow("Autenticación del Cliente").UIAObject("Movistar").UIAObject("Score").Exist) Or (JavaDialog("Error Message").Exist) Or (JavaWindow("Ejecutivo de interacción").JavaDialog("Autenticación del Cliente").JavaDialog("Error Message").Exist)) = False
'				wait 1
'				t = t + 1
'				If t >= 60 Then
'					DataTable("s_Resultado", dtLocalSheet) = "Fallido"
...
'			Wend
'		
'		If JavaDialog("Error Message").Exist Then
...
'		End If	
'		
'		If JavaWindow("Ejecutivo de interacción").JavaDialog("Autenticación del Cliente").JavaDialog("Error Message").Exist Then
'			varerror=JavaWindow("Ejecutivo de interacción").JavaDialog("Autenticación del Cliente").JavaDialog("Error Message").JavaObject("JPanel_2").GetROProperty("text")
'			DataTable("s_Resultado", dtLocalSheet) = "Fallido"
...
'
'			
'		If UIAWindow("Ejecutivo de interacción").UIAWindow("Autenticación del Cliente").UIAObject("Movistar").UIAObject("Score").Exist Then
'			UIAWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() &Num_Iter&"_"&"ValidarScore"&".png", True
'			imagenToWord "Validación de Score", RutaEvidencias() &Num_Iter&"_"&"ValidarScore"&".png"
'			
'			If Window("Ejecutivo de interacción").Window("Autenticación del Cliente").Dialog("Mensaje de página web").WinButton("Aceptar").Exist(2) Then
'				Window("Ejecutivo de interacción").Window("Autenticación del Cliente").Dialog("Mensaje de página web").WinButton("Aceptar").Click
'			End If
'			UIAWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() &Num_Iter&"_"&"Autenticación del Cliente_2"&".png", True
'			imagenToWord "Autenticación del Cliente_2", RutaEvidencias() &Num_Iter&"_"&"Autenticación del Cliente_2"&".png"
'			wait 2
'			UIAWindow("Ejecutivo de interacción").UIAWindow("Autenticación del Cliente").UIAObject("Movistar").UIAButton("Continuar_2").Click
'			wait 2
'		End If
'		
'		If Window("Ejecutivo de interacción").Window("Autenticación del Cliente").Dialog("Mensaje de página web").WinButton("Aceptar").Exist Then
'			Window("Ejecutivo de interacción").Window("Autenticación del Cliente").Dialog("Mensaje de página web").WinButton("Aceptar").Click
'		End If
'			
'			t = 0
'			While (UIAWindow("Ejecutivo de interacción").UIAWindow("Autenticación del Cliente").UIAObject("Movistar").UIAObject("No conoce centro poblado").Exist) = False
'				Wait 1
'				t = t + 1
'				If t >= 60 Then
'					DataTable("s_Resultado", dtLocalSheet) = "Fallido"
...
'			Wend
'			
'		If UIAWindow("Ejecutivo de interacción").UIAWindow("Autenticación del Cliente").UIAObject("Movistar").UIAObject("Consulta Cobertura").Exist(2) Then
'			UIAWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() &Num_Iter&"_"&"Autenticación del Cliente_3"&".png", True
'			imagenToWord "Autenticación del Cliente_3", RutaEvidencias() &Num_Iter&"_"&"Autenticación del Cliente_3"&".png"
'			UIAWindow("Ejecutivo de interacción").UIAWindow("Autenticación del Cliente").UIAObject("Movistar_2").UIAButton("Continuar").Click
'		End If
'			
'		If Window("Ejecutivo de interacción").Window("Autenticación del Cliente").Dialog("Mensaje de página web").WinButton("Aceptar").Exist(3) Then
'			Window("Ejecutivo de interacción").Window("Autenticación del Cliente").Dialog("Mensaje de página web").WinButton("Aceptar").Click
'		End If
'	End If
...
Sub RecursosAlta()
	...
	'JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaEdit("TextFieldNative$1").Type "920%%%%%%"
	wait 2
...
'			ExitActionIteration
	...
	For Iterator = 0 To Count-1
		...
		If rs = DataTable("e_MotivoAlta", dtLocalSheet) Then
				JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Pago Inmediato").JavaList("Medio de pago").Select DataTable("e_MotivoAlta", dtLocalSheet)
			Exit for
		ElseIf Iterator = Count-1 Then
...
Sub PagoManual()
	...
	If DataTable("e_MetodoPago",dtLocalSheet)<>"Pago a la Factura" Then
